                            ...
                            <tr>
                                ...
                                <td class="woocs-options-fix6">
                                    ...
                                    <ul class="woocs-ml-15">
                                        ...
                                        <li><a href="javascript: woocs_stat_redraw(2); void(0);" id="woocs_stat_redraw_2" class="woocs_stat_redraw_btn woocs-panel-button dashicons-before dashicons-update"><?php echo $this->statistic->get_label(2) ?></a>&nbsp;<label class="woocs-options-valign-top"><span class="woocommerce-help-tip" data-tip="<?php echo __('For currencies - aggregated data about count of countries which users selected currencies on the site front. For orders - count of orders made from countries, detected by selected country in the Užsakymo adresas.', 'woocommerce-currency-switcher') ?>"></span></label></li>
                                    </ul>
                                </td>
                            </tr>
                        </table>

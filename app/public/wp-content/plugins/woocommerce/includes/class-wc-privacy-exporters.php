	...
	protected static function get_customer_personal_data( $user ) {
		...
		$props_to_export = apply_filters(
			...
			array(
				...
				'billing_address_1'   => __( 'Užsakymo adresas 1', 'woocommerce' ),
				'billing_address_2'   => __( 'Užsakymo adresas 2', 'woocommerce' ),
	...
	protected static function get_order_personal_data( $order ) {
		...
		$props_to_export = apply_filters(
			...
			array(
				...
				'formatted_billing_address'  => __( 'Užsakymo adresas', 'woocommerce' ),

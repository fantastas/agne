...
- Fix issue in which email and phone fields are cleared when using a separate Užsakymo adresas. ([4162](https://github.com/woocommerce/woocommerce-gutenberg-products-block/pull/4162))
...
- Sync shipping address with Užsakymo adresas when shipping address fields are disabled. This fixes a bug where taxes would not reflect changes in Užsakymo adresas when they are set to be calculated from Užsakymo adresas ([3358](https://github.com/woocommerce/woocommerce-gutenberg-products-block/pull/3358))
